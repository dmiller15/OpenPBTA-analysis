...
1. `CRANIO, ADAM`:patient has CTNNB1.Exon3 mutation
1. `CRANIO, ADAM;CRANIO, PAP` Both of the above
...
snv_subtype <-
  ...
  mutate(molecular_subtype =
           case_when(
             (BRAF.V600E & fourty_or_older) & !CTNNB1.Exon3 ~ "CRANIO, PAP",
             !(BRAF.V600E & fourty_or_older) & CTNNB1.Exon3 ~ "CRANIO, ADAM",
             (BRAF.V600E & fourty_or_older) & CTNNB1.Exon3 ~ "CRANIO, ADAM;CRANIO, PAP",
             !(BRAF.V600E & fourty_or_older) & !CTNNB1.Exon3 ~ "CRANIO, To be classified"
           )) %>%
